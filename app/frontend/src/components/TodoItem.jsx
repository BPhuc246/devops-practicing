    ...
    >
      ...
      <div className="flex-1 min-w-0">
        {editing ? (
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="ml-auto flex gap-1">
                <button
                  onClick={handleSave}
                  className="text-xs px-3 py-1 bg-[var(--sage)] text-white rounded-lg hover:opacity-90 transition-opacity"
                >
                  Lưu
                </button>
                <button
                  onClick={() => setEditing(false)}
                  className="text-xs px-3 py-1 border border-[var(--border)] text-[var(--muted)] rounded-lg hover:bg-[var(--border)]/40 transition-colors"
                >
                  Huỷ
                </button>
              </div>
          ...
          <div>
            <p
              className={`text-sm leading-relaxed break-words font-body ${todo.completed ? "line-through text-[var(--muted)]" : "text-[var(--ink)]"}`}
            >
              {todo.title}
            </p>
            <div className="flex items-center gap-2 mt-1.5">
              <span
                className={`inline-flex items-center gap-1 text-xs font-mono ${p.text}`}
              >
